        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              ...
              <div className="relative rounded-sm overflow-hidden border border-white/15 bg-[#251522] shadow-2xl group transition-all duration-300">
                <div
                ...
                >
                  ...
                  <div className="absolute top-3 left-3 px-3 py-1 rounded-xs bg-black/75 backdrop-blur-md border border-white/15 text-[11px] font-semibold tracking-wider text-[#E8BD6F] uppercase">
                    {currentItem.badge}
                  </div>

                  <div className="absolute inset-x-0 bottom-0 pt-16 pb-5 px-5 sm:px-6 bg-gradient-to-t from-black/95 via-black/85 via-50% to-transparent flex items-end justify-between gap-4">
                    ...
                    {featuredList.map((_, idx) => (
                      <button
                        ...
                        className={`h-1.5 rounded-full transition-all cursor-pointer ${
                          idx === activeSlide ? 'w-6 bg-[#D99E41]' : 'w-2 bg-white/20 hover:bg-white/40'
                        }`}
                      />
                    ))}
                  </div>
